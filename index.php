...
<body>
    ...
    <script>
        function first(){
            document.getElementById('banner_image').src = "./images/Slider/1.png";
        }
        function second(){
            document.getElementById('banner_image').src = "./images/Slider/2.png";
        }
        function third(){
            document.getElementById('banner_image').src = "./images/Slider/3.png";
        }
        function fourth(){
            document.getElementById('banner_image').src = "./images/Slider/4.png";
        }
        function fifth(){
            document.getElementById('banner_image').src = "./images/Slider/5.png";
        }
